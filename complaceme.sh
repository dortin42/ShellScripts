...
ProgramasArchPacman=$"filezilla speedcrunch tmux phpmyadmin git curl virtualbox tilda libyaml nodejs php-mcrypt apache python-pip php mariadb wordpress postgresql unrar ruby python linux-headers dkms net-tools virtualbox-host-dkms powerline-vim vim npm virtualbox-guest-iso leafpad php-apache"
