...
sudo apt-fast -y install sublime-text default-jdk default-jre postgresql postgresql-contrib libpq-dev dukto sublime-text php-cli ruby nodejs php-mysql rar unrar npm git mysql-client mysql-server php7.0 libapache2-mod-php libapache2-mod-php7.0 php phpmyadmin php-mcrypt apache2 haguichi tilda virtualbox pavucontrol gdebi vlc qbittorrent zsh git-core git curl zlib1g-dev build-essential libssl-dev libreadline-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev libcurl4-openssl-dev python-software-properties libffi-dev python-pip python3 
